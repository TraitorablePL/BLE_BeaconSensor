...
#define MIN_CONN_INTERVAL                	MSEC_TO_UNITS(90, UNIT_1_25_MS)            /**< Minimum acceptable connection interval (0.4 seconds). */
#define MAX_CONN_INTERVAL                	MSEC_TO_UNITS(110, UNIT_1_25_MS)            /**< Maximum acceptable connection interval (0.65 second). */
